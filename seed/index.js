...
db.Country.create({ name: "Italy", id: 6 }).then((res) => {
  const top5s = [
    ...
    {
      name: "¿Puedo usar el baño? – 'Can I use the bathroom?'",
      category: "language",
      CountryId: 1,
    },
    ...
    {
      name:
        "Spain has a festival called La Tomatina, during the last week of August where massive crowds throw tomatoes at each other for pure entertainment.",
      category: "funfact",
      CountryId: 1,
    },
    //FRANCE
    ...
    {
      name: "¿puis-je utiliser les toilettes? – 'Can I use the bathroom?'",
      category: "language",
      CountryId: 2,
    },
    ...
    {
      name:
        "The Tour de France is a 21-day long bicycle race that often covers over 2,000 miles!",
      category: "funfact",
      CountryId: 2,
    },
  //UNITED STATES
  { name: "Metropolitan Museum of Art", category: "museums", CountryId: 3 },
  { name: "Smithsonian", category: "museums", CountryId: 3 },
  { name: "Art Institute of Chicago", category: "museums", CountryId: 3 },
  { name: "The Getty Center", category: "museums", CountryId: 3 },
  { name: "The Museum of Fine Arts Boston", category: "museums", CountryId: 3 },

  { name: "Le Bernardin", category: "restaurants", CountryId: 3 },
  { name: "Alinea", category: "restaurants", CountryId: 3 },
  { name: "Spago", category: "restaurants", CountryId: 3 },
  { name: "Restaurant Guy Savoy", category: "restaurants", CountryId: 3 },
  { name: "Per Se", category: "restaurants", CountryId: 3 },

  { name: "Grand Canyon", category: "sights", CountryId: 3 },
  { name: "Manhattan", category: "sights", CountryId: 3 },
  { name: "Yellowstone", category: "sights", CountryId: 3 },
  { name: "Mount Rushmore", category: "sights", CountryId: 3 },
  { name: "Florida Keys", category: "sights", CountryId: 3 },

  { name: "T'aa shoodi - 'Please'", category: "language", CountryId: 3 },
  { name: "Salamat - 'Thank you'", category: "language", CountryId: 3 },
  { name: "打扰一下 (Dǎrǎo yīxià) - 'Excuse Me'", category: "language", CountryId: 3 },
  { name: "¿Puedo usar el baño? – 'Can I use the bathroom?'", category: "language", CountryId: 3 },

  { name: "The United States does not have an official language. English is the most commonl spoken but on a federal level, there is no declared, official language", category: "funfact", CountryId: 3 },
    ...
    {
      name: "Пожалуйста (Pozhaluysta) - 'Please'",
      category: "language",
      CountryId: 4,
    },
    {
      name: "Спасибо (Spasibo) - 'Thank you'",
      category: "language",
      CountryId: 4,
    },
    {
      name: "Извините (Izvinite) - 'Excuse Me'",
      category: "language",
      CountryId: 4,
    },
    {
      name:
        "могу я воспользоваться туалетом (mogu ya vospol'zovat'sya tualetom) – 'Can I use the bathroom?'",
      category: "language",
      CountryId: 4,
    },
    ...
    {
      name:
        "Russia's Lake Baikal is the oldest and the deepest fresh water lake in the world.",
      category: "funfact",
      CountryId: 4,
    },
    //MEXICO
    ...
    {
      name:
        "Chocolate originated in Mexico, tracing back to the Aztecs, Mayans, and Olmecs.",
      category: "funfact",
      CountryId: 5,
    },
    //ITALY
    ...
    {
      name: "Posso usare il bagno? – 'Can I use the bathroom?'",
      category: "language",
      CountryId: 6,
    },
    ...
    {
      name:
        "Italy's holds one of the oldest and largest film festivals in the world, the Venice Film Festival.",
      category: "funfact",
      CountryId: 6,
    },
  ];
